...
CREATE TABLE `produtos` (
  ...
  CONSTRAINT `categoria_id` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `produtos` VALUES (4,'Maças','3','descrição',15,5,1),(6,'Mamão','5','Fresco',30,5,1);
...
-- Dump completed on 2020-01-21 11:50:00
